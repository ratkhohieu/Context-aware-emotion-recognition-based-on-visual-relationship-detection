...
def main():
    ...
    for fold in range(5):
        ...
        model = Emotic_v11(num_context_features=2048, num_body_features=2048, num_hook=128, cont_vad=False,
        ...
        scheduler_steplr = CosineAnnealingLR(optimizer, args.num_epochs, eta_min=4e-4, last_epoch=-1)
