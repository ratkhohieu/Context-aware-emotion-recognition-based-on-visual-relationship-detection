...
class TemporalLSTM(nn.Module, ABC):
    def __init__(self, n_features=2048, hidden_size=512, n_class=3, num_layers=2, drop=0.4):
        ...
        #     input_size=n_features, hidden_size=hidden_size, bidirectional=True, batch_first=True, dropout=drop
        # )
        self.lstm_attention = Attention(hidden_size * 2, 32)
