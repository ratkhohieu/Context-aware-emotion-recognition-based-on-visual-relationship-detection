...
parser.add_argument('--num_epochs', default=5, type=int, help='number epochs')
...
def main():
    ...
    for fold in range(5):
        ...
        model = torch.load(f'./weight/checkpoints/{fold}_model_alldataset2.pth')
        # import pdb; pdb.set_trace()
            ...
            for epoch in t:
                ...
                with torch.no_grad():
                    ...
                    if ap.mean() > best_scores:
                        ...
                        torch.save(model, f'./weight/checkpoints/{fold}_model_filled.pth')
