...
def main():
    ...
    model_hook = Sentiment_MLP(256, 4, 50, N=10, num_sentiment=4096, embracement_size=64)
    model = Emotic_v3(num_context_features=2048, num_body_features=2048, num_hook=64)
